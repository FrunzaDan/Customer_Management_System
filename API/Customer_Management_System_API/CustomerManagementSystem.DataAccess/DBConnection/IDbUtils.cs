...
public interface IDbUtils
{
    ...
    public Task<ResponseModel<CustomerModel>> GetCustomer(GetCustomerRequest getCustomerRqst);
    public Task<ResponseModel<CustomerListModel>> GetCustomers();
    ...
    public Task<ResponseModel<ResultValidityCheck>> CheckMerchantCredentialsFromDb(MerchantCredentials merchantCredentials);
}